   ...
   render() {
      ...
      return (
         <View>
            ...
            <TouchableHighlight style={styles.button} onPress={() => this.props.navigation.navigate("SaveToFile")} >
		        <Text>Shrani Datoteko</Text>
		    </TouchableHighlight>
            <TouchableHighlight style={styles.button} onPress={() => this.props.navigation.navigate("ReadFromFile")} >
            ...
            <TouchableHighlight style={styles.button} onPress={() => AsyncStorage.setItem("beeps", "")} >
