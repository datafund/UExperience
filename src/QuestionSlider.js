...
import { Text, View, TouchableHighlight, AsyncStorage, Slider} from 'react-native'
...
class QuestionSlider extends Component {
    ...
    render() {
        ...
        <TouchableHighlight style={styles.button} 
            onPress = {() => this.saveAnswer(this.state.itemId, this.state.question, "Slider", this.state.currentAnswer )}
        >
        <Text>
            Save
        </Text>
